  ...
  <div class="home flex">
    <div class="content flex">
      ...
      <div class="rightme">
        ...
        <p>
          Alex este un hairstylist cu o viziune modernă și un simț fin al stilului. Cu o atenție deosebită pentru
          proporții, textură și culoare, el reușește să creeze coafuri personalizate care evidențiază unicitatea
          fiecărui client. Este cunoscut pentru precizia sa tehnică și pentru capacitatea de a oferi sfaturi sincere și
          eficiente în alegerea look-ului potrivit.
        </p>
        </br>
      </div>
    </div>
...
<footer>
  ...
  <div class="grid">
    <div class="item">
      <h2>About</h2>
      <p>We create beauty with care, passion, and a touch of style.</p>
    </div>
    <div class="item">
      <h2>Instagram</h2>
      <div class="insta">
