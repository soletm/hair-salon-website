      ...
      <div class="navbar">
        ...
        <nav>
          <ul id="menuitem">
            ...
            <li class="active"><a href="artisti.php">Echipa</a></li>
  ...
  <div class="home flex">
    <div class="content flex">
      ...
      <div class="rightme">
        ...
        <p>
          Paul este un hairstylist cu un simț estetic excelent și o abilitate remarcabilă de a transforma ideile în
          stiluri care inspiră. Cu o energie pozitivă și o atitudine prietenoasă, Paul creează un ambient relaxat și
          plăcut pentru fiecare client. Este mereu la curent cu cele mai noi tehnici și tendințe, aducând un suflu fresh
          în fiecare coafură realizată. Indiferent dacă este vorba de o schimbare radicală sau o întreținere de rutină,
          Paul abordează fiecare look cu atenție, creativitate și pasiune.
        </p>
        </br>
      </div>
    </div>
