...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="column">
        <a href="mada.php">
          <img src="image/mada2.jpg" alt="Mada" style="width:70%">
          <br>
          <p>Madalina Panduru
          ...
          <div class="item">
            <div class="insta">
              <a href="https://www.instagram.com/madalinapanduruhairstylist/">
                <img src="image/insta.png" alt="Instagram" style="width:35px;height:35px;">
              </a>
            </div>
          </div>
      </div>
      <div class="column">
        <a href="marius.php">
          <img src="image/marius2.jpg" alt="Marius" style="width:70%">
          <br>
          <p>Marius Agurita</p>
          </br>
          <div class="item">
            <div class="insta">
              <a href="https://www.instagram.com/marius_agurida/">
                <img src="image/insta.png" alt="Instagram" style="width:35px;height:35px;">
              </a>
            </div>
          </div>
      ...
      <div class="column">
        <a href="paul.php">
          <img src="image/paul2.jpg" alt="Paul" style="width:70%">
          <br>
          <p>Paul Hamech</p>
          </br>
          <div class="item">
            <div class="insta">
              <a href="https://www.instagram.com/hamechpaul.hairstylist/">
                <img src="image/insta.png" alt="Instagram" style="width:35px;height:35px;">
              </a>
            </div>
          </div>
      ...
      <div class="column">
        <a href="alex.php">
          <img src="image/zigky2.jpg" alt="Alex" style="width:70%">
          <br>
          <p>Alex Constantin</p>
          </br>
          <div class="item">
            <div class="insta">
              <a href="https://www.instagram.com/alexconstantinconcept/">
                <img src="image/insta.png" alt="Instagram" style="width:35px;height:35px;">
              </a>
            </div>
          </div>
